...
<<<<<<< HEAD
                <h1 class="m-0 text-primary text-uppercase">Pratik Hotel</h1>
=======
<<<<<<< HEAD
                <h1 class="m-0 text-primary text-uppercase">RAJ Hotel</h1>
=======
                <h1 class="m-0 text-primary text-uppercase">Rajat Hotel</h1>
>>>>>>> main
>>>>>>> QA
            </a>
        </div>
            ...
            <div class="row gx-0 bg-white d-none d-lg-flex">
                <div class="col-lg-7 px-5 text-start">
                    <div class="h-100 d-inline-flex align-items-center py-2 me-4">
                        ...
                        <p class="mb-0">Prateekchaudhary7805@gmail.com</p>
                    </div>
